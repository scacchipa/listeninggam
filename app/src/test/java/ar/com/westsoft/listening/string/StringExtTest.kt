...
class StringExtTest {
    ...
    @Test
    fun prevWordTest() {
        Assert.assertEquals(null, txt.prevWord(27))
        ...
        Assert.assertEquals(2, txt.prevWord(4))
        Assert.assertEquals(0, txt.prevWord(2))
    ...
    @Test
    fun rewindWordsTest() {
        Assert.assertEquals(null, txt.rewindWords(27, 2))
        Assert.assertEquals(6, txt.rewindWords(26, 2))
        Assert.assertEquals(2, txt.rewindWords(24, 4))
        Assert.assertEquals(4, txt.rewindWords(16, 2))
        Assert.assertEquals(2, txt.rewindWords(6, 2))
        Assert.assertEquals(0, txt.rewindWords(4, 2))
    ...
    fun rewindWordsOrFirstTest() {
        Assert.assertEquals(null, txt.rewindWordsOrFirst(27, 2))
        Assert.assertEquals(6, txt.rewindWordsOrFirst(26, 2))
        Assert.assertEquals(2, txt.rewindWordsOrFirst(24, 4))
        Assert.assertEquals(4, txt.rewindWordsOrFirst(16, 2))
        Assert.assertEquals(2, txt.rewindWordsOrFirst(6, 2))
